...
orders.get('/getAllOrders', async (req, res) => {
  try {
    const query = `
      SELECT 
        o.orderId, o.state, o.pin, o.orderDate, o.username, o.city, o.total, o.userId,
        od.productId, od.qty, od.price, od.amount
      FROM orders o
    ...
    pool.query(query, (error, results) => {
      if (error) {
        ...
        res.status(200).json({ success: true, message: 'All Orders Fetched', data: results });
      }
    });
  } catch (error) {
