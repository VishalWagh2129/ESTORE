...
import { PluginsAddComponent } from './plugins/plugins-add/plugins-add.component';
import { PluginsDetailComponent } from './plugins/plugins-detail/plugins-detail.component';
...
export const routes: Routes = [
    ...
    { path: 'admin-signup', component: AdminSignupComponent },
    {
        ...
        children: [
            ...
            { path: 'plugins', component: PluginsListComponent },
            { path: 'plugins/add', component: PluginsAddComponent },
            { path: 'plugin-view', component: PluginsDetailComponent },
        ]
    },
    {
