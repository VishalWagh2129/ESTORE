...
export class SubCategoryComponent implements OnInit {
  ...
  deleteBrand(data){
    this.subcategoryService.delete(data.udid).subscribe((res:any)=>{
      if(res.success){
  ...
  editBrand(data){  
    this.router.navigate(['/admin/subcategory/add/'], { queryParams: { id: data.udid,mode:'edit'} });
  }

  addBrand(){
    this.router.navigate(['/admin/subcategory/add'], {queryParams: { mode:'add'} });
  }
